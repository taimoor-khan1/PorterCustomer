    ...
    <>
      ...
      <Animated.View
        style={[
          ...
          props.topHeaderStyle && props.topHeaderStyle,
          // {marginTop: 150},
        ]}>
        <Animated.ScrollView
          ...
          <View>
            <View style={[style.row]}>
              {props.tabs &&
                props.tabs.map((food, i) => (
                  <TouchableWithoutFeedback
                    key={i}
                    onPress={e => handleScroll(food.catagory)}
                    onLayout={e =>
                      handleTab(food.catagory, e.nativeEvent.layout)
                    }>
            ...
            <Animated.View style={[{translateX: value}]}>
              <Animated.View
                style={[style.indicator, {width: widthValue}]}></Animated.View>
            </Animated.View>
          </View>
        </Animated.ScrollView>
      </Animated.View>
      ...
      <Animated.ScrollView
        ...
        onScroll={Animated.event(
          [
            {
              nativeEvent: {
                contentOffset: {y: props.ÄnimatedScrollValue || animScroll},
              },
            },
          ],
        ...
        <View style={{paddingHorizontal: 15, backgroundColor: 'white'}}>
          {props.tabs &&
            props.tabs.map(food => (
              <View
                onLayout={e =>
                  handleTabContent(food.catagory, e.nativeEvent.layout)
                }>
...
export default React.memo(MyScroller);
